<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Service.aspx.cs" Inherits="AssesmentWeb.HOME.Services" %>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <p align="center">
                            <asp:Button ID="btnNewVehicleRegistration" runat="server" Text="NEW VEHICLE REGISTRATION" OnClick="btnNewVehicleRegistration_Click" CssClass="Btn1"></asp:Button>
                    ...
                    <td>
                        <p align="center">
                            <asp:Button ID="btnTransferOfOwnership" runat="server" Text="TRANSFER OF OWNERSHIP " OnClick="btnTransferOfOwnership_Click" CssClass="Btn1"></asp:Button>
