<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeOfOwnership.aspx.cs" Inherits="AssesmentWeb.HOME.SERVICES.ChangeOfOwnership" %>


<%@ Register Src="~/HOME/USER CONTROLS/CheckAadhar.ascx" TagPrefix="uc1" TagName="CheckAadhar" %>
        ...
        <div style="width: 80%;">
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="LblCheckAadhar" runat="server" Text="CHECK AADHAR : " CssClass="lbl"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtChkAadhar" runat="server" Width="256" CssClass="txtBox"></asp:TextBox>
                            </td>
                            <td>
                               
                               <asp:RequiredFieldValidator ID="rfvCheckAadhar" style="color:red;font-size:xx-large;" runat="server" ErrorMessage="*" ControlToValidate="txtChkAadhar"></asp:RequiredFieldValidator>
