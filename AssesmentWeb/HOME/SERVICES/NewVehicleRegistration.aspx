<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewVehicleRegistration.aspx.cs" Inherits="AssesmentWeb.HOME.SERVICES.NewVehicleRegistration" %>
...
<body>
    ...
    <form runat="server">
        ...
        <div>
            <uc1:CheckAadhar runat="server" id="CheckAadhar" />
        </div>
        <div>
            <footer id="copyright">
